...
const Requirement:React.FC<Props> = ({seeAllButton = false,title,color='gray',bg}) => {
  return (
    <div className={`px-16 relative bg-no-repeat z-0 bg-cover  py-10  min-h-82 ${bg && "bg-[url('./grid.png')]" }`}>
  ...
  <div className="flex justify-between items-center max-w-7xl mx-auto px-4">
      ...
      </p>
     {
      ...
      {/* Card */}
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 mt-10 max-w-7xl mx-auto px-4">
    <RecentProductCard/>
    <RecentProductCard/>
    <RecentProductCard/>
    </div>
